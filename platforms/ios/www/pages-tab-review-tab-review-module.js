(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tab-review-tab-review-module"],{
...
/***/ "./src/app/pages/tab-review/tab-review.module.ts":
/*!*******************************************************!*\
  !*** ./src/app/pages/tab-review/tab-review.module.ts ***!
  \*******************************************************/
/*! exports provided: TabReviewPageModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabReviewPageModule", function() { return TabReviewPageModule; });
...
/* harmony import */ var _tab_review_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./tab-review.page */ "./src/app/pages/tab-review/tab-review.page.ts");
...
var TabReviewPageModule = /** @class */ (function () {
    function TabReviewPageModule() {
    }
    TabReviewPageModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            imports: [
                ...
                _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"].forChild([{ path: '', component: _tab_review_page__WEBPACK_IMPORTED_MODULE_6__["TabReviewPage"] }])
            ],
            declarations: [_tab_review_page__WEBPACK_IMPORTED_MODULE_6__["TabReviewPage"]]
        })
    ], TabReviewPageModule);
    return TabReviewPageModule;
}());
...
/***/ "./src/app/pages/tab-review/tab-review.page.html":
/*!*******************************************************!*\
  !*** ./src/app/pages/tab-review/tab-review.page.html ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n  <ion-toolbar>\n    <ion-title class=\"ion-text-center\">\n\t\t진료 기록\n\t</ion-title>\n\t<ion-button slot=\"end\" shape=\"round\" size=\"small\" (click)=\"createReview()\">\n\t\t<ion-icon slot=\"icon-only\" name=\"add-circle\"></ion-icon>\n\t</ion-button>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content class=\"ion-padding\">\n\t<ion-calendar [(ngModel)]=\"date\" [format]=\"'YYYY-MM-DD'\">\n\n\t</ion-calendar>\n\n\t<!--ion-button (click)=\"toggleInfiniteScroll()\" expand=\"block\">\n\t\tToggle Infinite Scroll\n\t</ion-button-->\n\t\n\t<ion-item *ngFor=\"let item of dataList\">\n\t\t<ion-label (click)=\"showReview()\">{{item}}</ion-label>\n\t</ion-item>\n\t\n\t<ion-infinite-scroll threshold=\"100px\" (ionInfinite)=\"loadData($event)\">\n\t\t<ion-infinite-scroll-content\n\t\tloadingSpinner=\"bubbles\"\n\t\tloadingText=\"Loading more data...\">\n\t\t</ion-infinite-scroll-content>\n\t</ion-infinite-scroll>\n</ion-content>"

/***/ }),

/***/ "./src/app/pages/tab-review/tab-review.page.scss":
/*!*******************************************************!*\
  !*** ./src/app/pages/tab-review/tab-review.page.scss ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3BhZ2VzL3RhYi1yZXZpZXcvdGFiLXJldmlldy5wYWdlLnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/pages/tab-review/tab-review.page.ts":
/*!*****************************************************!*\
  !*** ./src/app/pages/tab-review/tab-review.page.ts ***!
  \*****************************************************/
/*! exports provided: TabReviewPage */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "TabReviewPage", function() { return TabReviewPage; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
...
var TabReviewPage = /** @class */ (function () {
    function TabReviewPage(router) {
        this.router = router;
        this.dataList = [6, 4, 2, 3, 1];
        console.log(this.dataList);
    }
    TabReviewPage.prototype.loadData = function (event) {
        var _this = this;
        console.log("load data");
        setTimeout(function () {
            console.log('Done');
            for (var i = 0; i < 30; i++) {
                _this.dataList.push("Item Number : " + _this.dataList.length);
                console.log("fn : " + i);
            }
            event.target.complete();
    ...
    */
    TabReviewPage.prototype.createReview = function () {
        this.router.navigate(['/create-review']);
    };
    TabReviewPage.prototype.showReview = function () {
    ...
    ], TabReviewPage.prototype, "infiniteScroll", void 0);
    TabReviewPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-tab-review',
            template: __webpack_require__(/*! ./tab-review.page.html */ "./src/app/pages/tab-review/tab-review.page.html"),
            styles: [__webpack_require__(/*! ./tab-review.page.scss */ "./src/app/pages/tab-review/tab-review.page.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], TabReviewPage);
    return TabReviewPage;
}());
...
//# sourceMappingURL=pages-tab-review-tab-review-module.js.map